...
<head>
    ...
    <title>Buat Kampanye Baru - DonGiv Admin</title>
...
<body class="min-h-screen flex">
    ...
    <div class="flex-1 p-8 overflow-auto">
        <header class="mb-8 fade-in">
            <h2 class="text-3xl font-bold text-gray-800">Buat Kampanye Baru</h2>
            <p class="text-gray-600">Tambahkan kampanye donasi untuk membantu sesama</p>
        </header>
            ...
            <form action="{{ route('admin.campaigns.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="text" class="input-field w-full border border-gray-200 p-4 rounded-xl focus:outline-none focus:border-blue-300 pl-12 bg-gray-50/50 @error('title') border-red-300 @enderror"
                               id="title" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul kampanye">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="number" class="input-field w-full border border-gray-200 p-4 rounded-xl focus:outline-none focus:border-blue-300 pl-12 bg-gray-50/50 @error('target_amount') border-red-300 @enderror"
                               id="target_amount" name="target_amount" value="{{ old('target_amount') }}" required min="1000" placeholder="Masukkan jumlah target donasi">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <textarea class="input-field w-full border border-gray-200 p-4 rounded-xl focus:outline-none focus:border-blue-300 pl-12 bg-gray-50/50 @error('description') border-red-300 @enderror"
                                  id="description" name="description" rows="5" required placeholder="Jelaskan tujuan dan kebutuhan kampanye">{{ old('description') }}</textarea>
                ...
                <div class="flex space-x-4 pt-4">
                    <button type="submit" class="btn-primary flex-1 py-4 px-6 rounded-xl text-white font-semibold text-lg relative overflow-hidden">
                        <span class="relative z-10"><i class="fas fa-save mr-2"></i>Simpan Kampanye</span>
