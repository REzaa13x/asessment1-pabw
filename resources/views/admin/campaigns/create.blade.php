...
<div class="card shadow mb-4" style="border-left: 5px solid #007BFF;">
    <div class="card-header py-3" style="background-color: #003366;">
        <h6 class="m-0 font-weight-bold text-white">Formulir Kampanye Donasi Baru</h6>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('admin.campaigns.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('target_amount') is-invalid @enderror" id="target_amount" name="target_amount" value="{{ old('target_amount') }}" required min="1000">
